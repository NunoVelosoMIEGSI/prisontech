    ...
    <div class="row justify-content-center">
        <div class="col-8">
            <form name="editForm" role="form" novalidate v-on:submit.prevent="save()" >
                <h2 id="gatewayApp.eventosEvento.home.createOrEditLabel">Criar ou editar um evento</h2>
                <div>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" for="evento-descricao">Descrição</label>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" for="evento-numPessoasPerm">Número de pessoas permitidas</label>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" for="evento-numPessoasDet">Número de pessoas detetadas</label>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" for="evento-dataHoraInicio">Data/Hora de início</label>
                        <div class="d-flex">
                    ...
                    <div class="form-group">
                        <label class="form-control-label" for="evento-dataHoraFim">Data/Hora de fim</label>
                        <div class="d-flex">
                    ...
                    <div class="form-group">
                        <label class="form-control-label" for="evento-area">Área</label>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" for="evento-camara">Câmara</label>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" for="evento-tipoevento">Tipo de evento</label>
