                ...
                <div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="path" id="evento-path"
                            :class="{'valid': !$v.evento.path.$invalid, 'invalid': $v.evento.path.$invalid }" v-model="$v.evento.path.$model" />
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="formato" id="evento-formato"
                            :class="{'valid': !$v.evento.formato.$invalid, 'invalid': $v.evento.formato.$invalid }" v-model="$v.evento.formato.$model" />
                    </div>
                    <div class="form-group">
