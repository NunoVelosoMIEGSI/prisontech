<template>
    <div>
        <h2 id="page-heading">
            <span id="tipoevento-heading">Tipos de eventos</span>
        ...
        <b-modal ref="removeEntity" id="removeEntity" >
            <span slot="modal-title"><span id="gatewayApp.eventosTipoevento.delete.question">Confirmar operação</span></span>
            <div class="modal-body">
                <p id="jhi-delete-tipoevento-heading">Tem a certeza que deseja eliminar o registo?</p>
            </div>
            <div slot="modal-footer">
                <button type="button" class="btn btn-secondary" v-on:click="closeDialog()">Cancelar</button>
                <button type="button" class="btn btn-primary" id="jhi-confirm-delete-tipoevento" v-on:click="removeTipoevento()">Eliminar</button>
            </div>
        </b-modal>
    </div>
</template>
